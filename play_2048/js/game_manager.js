function GameManager(size, InputManager, Actuator, StorageManager, TelegramApi) {
...
GameManager.prototype.actuate = function () {
  ...
  if (this.over || this.won || this.isGameTerminated()) {
    this.telegram.updateScore(this.score);
  };
